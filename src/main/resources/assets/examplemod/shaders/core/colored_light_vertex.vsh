...
void main() {
    ...
    vec3 blockLightColor = pow(BlockLightColor, vec3(1.3));//vec3(0, BlockLightColor.g < 0.3 ? BlockLightColor.g / 2.0 : BlockLightColor.g, 0);// * max(BlockLightColor.r, max(BlockLightColor.g, BlockLightColor.b));
